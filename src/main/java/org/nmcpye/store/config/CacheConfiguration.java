package org.nmcpye.store.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.nmcpye.store.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.nmcpye.store.repository.UserRepository.USERS_BY_EMAIL_CACHE);
