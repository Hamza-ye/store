...
import org.nmcpye.store.domain.OrderItem;
import org.nmcpye.store.repository.OrderItemRepository;
import org.nmcpye.store.service.OrderItemService;
...
/**
 * REST controller for managing {@link org.nmcpye.store.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
